...
| --- | --- | --- | --- |
| `store-assets/screenshot-1.png` | 1586×992 | 1.60 | **Screenshot** (target 1280×800, aspect 1.60 — exact match). |
...
CWS requires at least 1 screenshot at **1280×800** or **640×400** (PNG/JPG). [`store-assets/screenshot-1.png`](store-assets/screenshot-1.png) (1586×992, exact 1.60 aspect) covers the requirement. For additional screenshots showing more interactions, capture:
